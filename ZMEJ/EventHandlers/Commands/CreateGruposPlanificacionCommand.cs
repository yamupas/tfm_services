...
{
    public class CreateGruposPlanificacionCommand : IRequest<CreateOrderResult>
    {
        ...
        public CreateGruposPlanificacionCommand(Guid vResControlProdId,string vGrupoPlanificador,string vDescripcion,Boolean vEstado,string vUsuarioCreacion="",string vUltimoUsuarioModificacion="")
        {
            try
            {
                Id = Guid.NewGuid();
